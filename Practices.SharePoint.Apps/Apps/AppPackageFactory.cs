namespace Practices.SharePoint.Apps {
    ...
    public static class AppPackageFactory {
        public static Stream CreatePackage(Guid identifier, string title, string launchUrl) {
            ...
            return CreatePackage(identifier, title, launchUrl, imageStream);
        }

        public static Stream CreatePackage(Guid identifier, string title, string launchUrl, MemoryStream imageStream) {
            MemoryStream stream = new MemoryStream();
            using (Package package = Package.Open(stream, FileMode.Create)) {
                PackagePart manifest = package.CreateAppManifest(identifier, title, launchUrl);
        ...
        public static SPAppPrincipal AppRegister(string identifier, string title, string launchUrl, SPWeb web) {
        ...
        public static SecureString GenerateSecret(int length) {
