...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserFieldEditor.ascx.cs"
    Inherits="Practices.SharePoint.FieldTypes.UserFieldEditor" %>
...
<wssuc:InputFormSection runat="server"
    ...
    <template_inputformcontrols>
		<Template_Control>
            <wssuc:InputFormControl LabelText="Pickup list" runat="server">
			    <Template_Control>
