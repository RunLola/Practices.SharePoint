...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SiteContentByQueryControl.ascx.cs" 
    Inherits="Practices.SharePoint.WebParts.SiteContentByQueryControl" %>
<!-- Ribbon & PageComponent -->
<SharePoint:ScriptLink Language="javascript" Name="sp.js" runat="server"  OnDemand="true" Localizable="false" />
<SharePoint:ScriptLink Language="javascript" Name="sp.ribbon.js" runat="server" LoadAfterUI="true" OnDemand="true" Localizable="false" />
