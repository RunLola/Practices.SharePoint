namespace Practices.SharePoint.FieldTypes {
    ...
    public class QuoteTextField : SPFieldText {
        ...
        public override BaseFieldControl FieldRenderingControl {
            ...
            get {
                BaseFieldControl fieldControl = new QuoteTextFieldControl() {
        ...
        public QuoteTextField(SPFieldCollection fields, string fieldName)
            : base(fields, fieldName) {
            Initialize();
        }

        public QuoteTextField(SPFieldCollection fields, string typeName, string displayName)
