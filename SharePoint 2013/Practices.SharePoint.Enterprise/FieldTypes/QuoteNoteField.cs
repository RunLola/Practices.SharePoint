namespace Practices.SharePoint.FieldTypes {
    ...
    public class QuoteNoteField : SPFieldMultiLineText {
        ...
        public override BaseFieldControl FieldRenderingControl {
            ...
            get {
                BaseFieldControl fieldControl = new QuoteNoteFieldControl() {
        ...
        public QuoteNoteField(SPFieldCollection fields, string fieldName)
            : base(fields, fieldName) {
            Initialize();
        }

        public QuoteNoteField(SPFieldCollection fields, string typeName, string displayName)
