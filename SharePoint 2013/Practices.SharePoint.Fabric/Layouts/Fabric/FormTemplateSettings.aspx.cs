    ...
    public partial class FormTemplateSettingsPage : LayoutsPageBase {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                ...
                GridCols.DataSource = fields;
                GridCols.DataBind();
            }
            //if (List != null && !List.AllowContentTypes) {
            //    List.SetFormTempalteName(SPControlMode.New, "FabricListForm");
            //    List.SetFormTempalteName(SPControlMode.Edit, "FabricListForm");
            //    List.SetFormTempalteName(SPControlMode.Display, "FabricListForm");
            //} else {
        ...
        protected void BtnSave_Click(object sender, EventArgs e) {
            using (SPLongOperation longOperation = new SPLongOperation(this.Page)) {
                ...
                longOperation.Begin();
                var jsonString = json.Value;
                var layout = JsonHelper.JsonDeserialize<FabricPageLayout>(jsonString);                
